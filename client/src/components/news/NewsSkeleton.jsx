        ...
        >
          ...
          <div className="p-4">
            <div className="mb-3 flex flex-wrap gap-2">
              <div className="h-6 w-24 rounded-full bg-slate-200 sm:w-28" />
              <div className="h-6 w-28 rounded-full bg-slate-200 sm:w-36" />
            </div>
            <div className="h-5 w-full rounded bg-slate-200" />
            <div className="mt-2 h-5 w-5/6 rounded bg-slate-200" />
            <div className="mt-3 h-4 w-full rounded bg-slate-200" />
            <div className="mt-2 h-4 w-4/5 rounded bg-slate-200" />
            <div className="mt-4 h-10 w-full rounded-xl bg-slate-200 sm:w-40" />
          </div>
        </div>
      ))}
    </div>
