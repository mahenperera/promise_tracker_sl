...
export async function adminListParties({
  ...
  return resolveResponse(res, "Failed to fetch parties");
}
...
export async function adminCreateParty(payload) {
  ...
  return resolveResponse(res, "Create party failed");
}
...
export async function adminUpdateParty(id, payload) {
  ...
  return resolveResponse(res, "Update party failed");
}
...
export async function adminDeactivateParty(id) {
  ...
  return resolveResponse(res, "Deactivate party failed");
}
